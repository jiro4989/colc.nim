...
var NTI128132 = {size: 0,kind: 24,base: null,node: null,finalizer: null};
var NTI128130 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
var NTI128260 = {size: 0,kind: 24,base: null,node: null,finalizer: null};
var NTI3862 = {size: 0, kind: 17, base: null, node: null, finalizer: null};
var NTI128146 = {size: 0,kind: 24,base: null,node: null,finalizer: null};
...
var NTI128015 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
var NTI131014 = {size: 0,kind: 16,base: null,node: null,finalizer: null};
var NNI128015 = {kind: 2, len: 3, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "name", len: 0, typ: NTI138, name: "name", sons: null}, 
...
NTI128146.base = NTI128015;
var NNI3862 = {kind: 2, len: 0, offset: 0, typ: null, name: null, sons: []};
NTI3862.node = NNI3862;
NTI3862.base = NTI3828;
NTI128260.base = NTI138;
NTI128132.base = NTI138;
var NNI128130 = {kind: 2, len: 3, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "Field0", len: 0, typ: NTI138, name: "Field0", sons: null}, 
{kind: 1, offset: "Field1", len: 0, typ: NTI128132, name: "Field1", sons: null}, 
{kind: 1, offset: "Field2", len: 0, typ: NTI138, name: "Field2", sons: null}]};
NTI128130.node = NNI128130;
...
function take_bracket_combinator_128019(code_128021) {
	var result_128022 = null;
	...
	framePtr = F;
		...
		L1: do {
			...
			var i_128047 = 0;
			F.line = 3841;
			var l_128049 = (code_128021 != null ? code_128021.length : 0);
			L2: do {
				F.line = 3842;
					L3: while (true) {
					if (!(i_128047 < l_128049)) break L3;
						...
						F.line = 3844;
						i_128047 = addInt(i_128047, 1);
						if (!(((code_128021 != null ? code_128021.length : 0) == l_128049))) {
						F.line = 3845;
	...
	return result_128022;

}

function take_prefix_combinator_128063(code_128065, cs_128067) {
	...
	BeforeRet: do {
		...
		L1: do {
			...
			L2: do {
				F.line = 2160;
					L3: while (true) {
					if (!(i_128111 < (cs_128067 != null ? cs_128067.length : 0))) break L3;
						F.line = 2161;
...
function new_seq_128141(len_128145) {
	var result_128147 = null;

	var F={procname:"newSeq.newSeq",prev:framePtr,filename:"../../../../../.choosenim/toolchains/nim-0.19.0/lib/system.nim",line:0};
	framePtr = F;
		F.line = 706;
		result_128147 = new Array(len_128145); for (var i=0;i<len_128145;++i) {result_128147[i]={name: null, argsCount: 0, format: null};}	framePtr = F.prev;

	return result_128147;
...
function take_combinator_128125(code_128127, cs_128129) {
	var result_128135 = {Field0: null, Field1: null, Field2: null};
	...
	BeforeRet: do {
		...
		L1: do {
			F.line = 420;
			var it_128180 = {name: null, argsCount: 0, format: null};
			F.line = 2159;
			var i_128349 = 0;
			L2: do {
				F.line = 2160;
					L3: while (true) {
					if (!(i_128349 < (cs_128129 != null ? cs_128129.length : 0))) break L3;
						F.line = 2161;
						nimCopy(it_128180, cs_128129[chckIndx(i_128349, 0, cs_128129.length+0-1)-0], NTI128015);
						if (eqStrings(it_128180.name, pref_128136)) {
						F.line = 421;
						var Tmp4 = nimCopy(null, it_128180, NTI128015);
						if (result_128172 != null) { result_128172.push(Tmp4); } else { result_128172 = [Tmp4]; };
						}
						
						F.line = 2162;
						i_128349 = addInt(i_128349, 1);
					}
			} while(false);
		} while(false);
...
function calc_format_128371(co_128373, args_128375) {
	var result_128376 = null;
	...
	framePtr = F;
		...
		L1: do {
			...
			var i_128386 = 0;
			F.line = 3527;
			var colontmp__128389 = 0;
			F.line = 54;
			colontmp__128389 = co_128373.argsCount;
			F.line = 3528;
			var i_128392 = 0;
			L2: do {
				F.line = 3529;
					L3: while (true) {
					if (!(i_128392 < colontmp__128389)) break L3;
						F.line = 3530;
						i_128386 = i_128392;
						F.line = 55;
						var f_128387 = (makeNimstrLit("{")).concat(cstrToNimstr((i_128386)+""),makeNimstrLit("}"));
						F.line = 56;
						result_128376 = nimCopy(null, nsuReplaceStr(result_128376, f_128387, args_128375[chckIndx(i_128386, 0, args_128375.length+0-1)-0]), NTI138);
						F.line = 3531;
						i_128392 = addInt(i_128392, 1);
					}
			} while(false);
		} while(false);
	framePtr = F.prev;
...
function calc_clcode1time_128407(code_128409, cs_128411) {
	var result_128412 = null;

	var F={procname:"combinator.calcCLCode1Time",prev:framePtr,filename:"combinator.nim",line:0};
	framePtr = F;
	BeforeRet: do {
		F.line = 60;
		var co_tuple_128413 = take_combinator_128125(code_128409, cs_128411);
		F.line = 61;
		F.line = 419;
		var result_128425 = new_seq_128141(0);
		L1: do {
			F.line = 420;
			var it_128433 = {name: null, argsCount: 0, format: null};
			F.line = 2159;
			var i_128458 = 0;
			L2: do {
				F.line = 2160;
					L3: while (true) {
					if (!(i_128458 < (cs_128411 != null ? cs_128411.length : 0))) break L3;
						F.line = 2161;
						nimCopy(it_128433, cs_128411[chckIndx(i_128458, 0, cs_128411.length+0-1)-0], NTI128015);
						if (eqStrings(it_128433.name, co_tuple_128413.Field0)) {
						F.line = 421;
						var Tmp4 = nimCopy(null, it_128433, NTI128015);
						if (result_128425 != null) { result_128425.push(Tmp4); } else { result_128425 = [Tmp4]; };
						}
						
						F.line = 2162;
						i_128458 = addInt(i_128458, 1);
					}
			} while(false);
		} while(false);
		var matched_128446 = nimCopy(null, result_128425, NTI128146);
		if (((matched_128446 != null ? matched_128446.length : 0) < 1)) {
		F.line = 63;
		result_128412 = nimCopy(null, code_128409, NTI138);
		break BeforeRet;
		}
		
		F.line = 64;
		var co_128454 = nimCopy(null, matched_128446[chckIndx(0, 0, matched_128446.length+0-1)-0], NTI128015);
		F.line = 65;
		result_128412 = nimCopy(null, calc_format_128371(co_128454, co_tuple_128413.Field1), NTI138);
	} while (false);
	framePtr = F.prev;

	return result_128412;

}

function calc_clcode_128472(code_128474, cs_128476, n_128478) {
	var result_128479 = null;

	var F={procname:"combinator.calcCLCode",prev:framePtr,filename:"combinator.nim",line:0};
	framePtr = F;
	BeforeRet: do {
		F.line = 68;
		var m_128480 = n_128478;
		if ((m_128480 == 0)) {
		F.line = 70;
		result_128479 = nimCopy(null, code_128474, NTI138);
		break BeforeRet;
		}
		
		if ((~(m_128480) == -1)) {
		F.line = 72;
		m_128480 = subInt(m_128480, 1);
		}
		
		F.line = 73;
		var ret_128491 = calc_clcode1time_128407(code_128474, cs_128476);
		if (eqStrings(code_128474, ret_128491)) {
		F.line = 75;
		result_128479 = nimCopy(null, code_128474, NTI138);
		break BeforeRet;
		}
		...
		F.line = 76;
		result_128479 = nimCopy(null, calc_clcode_128472(ret_128491, cs_128476, m_128480), NTI138);
	} while (false);
	framePtr = F.prev;

	return result_128479;
...
function calcCLCode(code_131035) {
	...
	BeforeRet: do {
		F.line = 11;
		result_131036 = toJSStr(calc_clcode_128472(cstrToNimstr(code_131035), cs_131016, -1));
		break BeforeRet;
	} while (false);
	framePtr = F.prev;
